    ...
    <body>
                            ...
                            <div class="w-full">
                                ...
                                <div id="client-box" style="display: none;">    
                                    ...
                                    <div class="mt-5">
                                        ...
                                        <input value="{{ old('client_signature_text') }}" name="client_signature_text" class="border-line px-4 pt-3 pb-3 w-full rounded-lg" id="client_signature_text" type="text" autocomplete="off">
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                ...
                const textInput = document.getElementById("client_signature_text");

                function drawSignature(text) {
                    ctx.clearRect(0, 0, canvas.width, canvas.height); // Clear previous signature

                    document.fonts.ready.then(() => {
                        ctx.font = "40px 'Great Vibes', cursive"; // Apply fancy signature font
                        ...
                        ctx.fillText(text, x, y); // Draw the typed text as a signature
                ...
                function handleCheckboxState() {
                    if (checkbox.checked) {
                        ...
                        if (textInput.value.trim() !== "") {
                            drawSignature(textInput.value); // Draw text as signature
                        }
                    } else {
                ...
                // Update signature pad whenever user types
