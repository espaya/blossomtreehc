                ...
                <div class="content-main lg:px-[60px] md:px-4 flex gap-y-8 max-md:flex-col w-full">
                    ...
                    <div class="right xl:w-2/3 md:w-7/12 w-full xl:pl-[40px] lg:pl-[28px] md:pl-[16px] flex items-start justify-center">
                        @if($policy && $policy->isNotEmpty())
                            ...
                            @endforelse
                        @else 
                        <form action="{{ route('account.policy.for.investigating') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="w-full">
                                <p style="text-align: center;">
                                    <b>BLOSSOM TREE HOME HEALTHCARE SERVICES LLC</b>
                                ...
                                <div class="mt-5">
                                    <label for="signature-text">Client or Clients’ Representative Name *</label>
                                ...
                                <div class="mt-5">
                                    ...
                                    <input value="{{ old('clients_rep_date') }}" name="clients_rep_date" class="border-line px-4 pt-3 pb-3 w-full rounded-lg" id="clients_rep_date" type="date" autocomplete="off">
                                    @error('clients_rep_date')
                                        <p style="color: red;"> {{ $message }} </p>
                                    @enderror
                                </div>
