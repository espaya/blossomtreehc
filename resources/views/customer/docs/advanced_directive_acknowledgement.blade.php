                    ...
                    <div class="right xl:w-2/3 md:w-7/12 w-full xl:pl-[40px] lg:pl-[28px] md:pl-[16px] flex items-start justify-center">
                        <form action="{{ route('account.advanced.directive') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="w-full">
                                ...
                                <div class="pass mt-5">
                                    Medical Record #<input name="medical_record_number" value="{{ old('medical_record_number') }}" class="border-line px-4 pt-3 pb-3 w-full rounded-lg" id="medical_record_number" type="text" autocomplete="off">
                                ...
                                <div class="flex items-center">
                                    <div class="block-input">
                                        <input type="radio" name="confirm" id="i_have_not" value="1" {{ old('confirm') == '1' ? 'checked' : '' }} >
                                        <i class="ph-fill ph-check-square icon-checkbox"></i>
                                    </div>
