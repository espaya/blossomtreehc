                ...
                <div class="content-main lg:px-[60px] md:px-4 flex gap-y-8 max-md:flex-col w-full">
                    ...
                    <div class="right xl:w-2/3 md:w-7/12 w-full xl:pl-[40px] lg:pl-[28px] md:pl-[16px] flex items-top">
                        <div class="text-content w-full">
                            ...
                            @endif
                            @error('archive')
                            <p style="color: red; margin-bottom:50ox"> {{ $message }} </p>
                            @enderror
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('career.archive') }}" method="post">
                                                    @csrf
                                                    @method('PATCH')
                                                    <input name="archive" hidden value="{{ $job->id }}" type="text">
                                                    <button title="Add to archives" type="submit" class="btn btn-info">           
                                        ...
                                        @empty
                                        <tr>
                                            <td colspan="9" class="text-center" style="color: red;">No Applications Available</td>
                                        </tr>
                                        @endforelse
                                    </tbody>
                                </table>
