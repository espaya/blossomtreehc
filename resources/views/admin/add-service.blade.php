            ...
            <div class="container">
                <div class="content-main lg:px-[60px] md:px-4 flex gap-y-8 max-md:flex-col w-full">
                    ...
                    <div class="text-content w-full">
                        ...
                        @endif
                            <form action="{{ route('admin.save.service') }}" method="post" enctype="multipart/form-data" class="">
                                @csrf
                                @method('POST')
                                <div class="heading5 pb-4">Service</div>
                                <div class="grid sm:grid-cols-2 gap-4 gap-y-5">
                                    <div class="first-name">
                                        <input name="title" value="{{ old('title') }}" class="border-line px-4 pt-3 pb-3 w-full rounded-lg" id="title" type="text" autocomplete="off" placeholder="Service title">
                                        @error('title')
