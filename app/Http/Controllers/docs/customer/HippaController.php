...
class HippaController extends Controller
{
    ...
    {        
        ...
        $hippa = Hippa::where('customerID', Auth::user()->id)->get();
    ...
    public function save(Request $request)
    {
        $request->validate([
            ...
            'clients_rep_date_signed' => ['nullable', 'required_if:ee_signature,1'],
        ], [
            ...
            'clients_signature' => 'Client\'s signature is required',
            'clients_signed_date' => 'Date signed is required',
